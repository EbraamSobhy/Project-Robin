                ...
                <div className={`transform transition-all duration-1000 ease-out ${
                    ...
                    <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-white/30 relative mt-10">
                        ...
                        <div className="relative z-10 flex flex-col items-center w-full">
                            <form className="w-full max-w-xl grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                <div className="flex items-center gap-4">
                                    <label htmlFor="plant-land-label" className="block bg-gray-700 font-bold text-2xl mb-2 whitespace-nowrap text-white px-1 py-2 rounded-lg shadow-sm">Land Number</label>
                                    <input
                                    id="plant-land-label"
                                    type="text"
                        ...
                        <div className="flex flex-col items-center mt-8">
                            <img src={image} alt="Plant Visual" className="w-[700px] h-[400px] object-cover rounded-xl shadow-lg" />
                        </div>
                    </div>
                </div>
                <ToastContainer />
