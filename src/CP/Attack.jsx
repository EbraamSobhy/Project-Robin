                                ...
                                <div className="flex flex-row items-center gap-8 mt-4">
                                    <div className="flex flex-col gap-4 flex-1">
                                        <div className="flex items-center gap-4">
                                            <label htmlFor="attack-land-label" className="block bg-gray-700 font-bold text-2xl mb-2 whitespace-nowrap text-white px-1 py-2 rounded-lg shadow-sm">Your  Land Number</label>
                                            <input
                                        ...
                                        {/* Duplicate Attack Target Number */}
                                        <div className="flex items-center gap-4">
                                            <label htmlFor="attack-target-label" className="block bg-gray-700 font-bold text-2xl mb-2 whitespace-nowrap text-white px-1 py-2 rounded-lg shadow-sm">Land you want to attack</label>
                                            <input
