        ...
        <>
            ...
            {isMobileMenuOpen && (
                <div className="fixed top-16 left-0 w-full bg-white shadow-lg z-40 lg:hidden border-b border-blue-200">
                    <div className="flex flex-col py-4 justify-center items-center">
                        ...
                        <button onClick={HarvestTab} className="flex items-center px-6 py-3 text-blue-700 bg-blue-50 transition"><GiCorn className="w-5 h-5 mr-3" /><span className="font-semibold">Harvest</span></button>
            ...
            <div className="min-h-screen bg-gradient-to-br from-sky-200 to-blue-300 flex items-center justify-center p-4 sm:p-8 lg:p-20 pt-20 lg:pt-20">
                ...
                <div className="hidden lg:flex fixed top-0 right-0 h-full w-24 bg-white shadow-lg flex-col items-center mt-[63px] z-50 border-l border-blue-200">
                    ...
                    {/* Trade Tab */}
                    <button onClick={Trade} className="w-full flex flex-col items-center py-2 px-2 group hover:bg-blue-50 transition relative"><span className="absolute left-0 top-0 h-full w-1 bg-transparent group-hover:bg-blue-500 rounded-r transition"></span><div className="w-12 h-12 flex items-center justify-center text-blue-500 mb-1"><GiTrade size={25} /></div><span className="text-xs text-blue-700 font-semibold">Trade</span></button>
                    {/* Take Tab */}
                    ...
                    {/* Harvest - Active */}
                    <button className="w-full flex flex-col items-center py-2 px-2 group bg-blue-50 transition relative"><span className="absolute left-0 top-0 h-full w-1 bg-blue-500 rounded-r transition"></span><div className="w-12 h-12 flex items-center justify-center text-blue-500 mb-1"><GiCorn size={25} /></div><span className="text-xs text-blue-700 font-semibold">Harvest</span></button>
                </div>
                ...
                <div className={`transform transition-all duration-1000 ease-out w-full max-w-xl ${
                    ...
                    <div className="bg-white/90 backdrop-blur-md rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-white/30 relative w-full">
                        ...
                        <div className="relative z-10 flex flex-col items-center w-full">
                            <form className="w-full flex flex-col md:flex-row gap-4 sm:gap-8">
                                ...
                                <div className="flex-1 ml-0 md:ml-14 w-full">
                                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-3 sm:p-6 border border-white/30">
                                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-4">Tiger</h3>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">apple: 3</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">Wheat: 4</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl mb-4 sm:mb-6">Watermelom: 1</h4>
                                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-4">Panther</h3>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">apple: 3</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">Wheat: 4</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl mb-4 sm:mb-6">Watermelom: 1</h4>
                                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-4">Lion</h3>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">apple: 3</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">Wheat: 4</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl mb-4 sm:mb-6">Watermelom: 1</h4>
                                    </div>
                                ...
                                <div className="flex-1 w-full">
                                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-3 sm:p-6 border border-white/30">
                                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-4">Wolf</h3>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">apple: 3</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">Wheat: 4</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl mb-4 sm:mb-6">Watermelom: 1</h4>
                                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-4">Fox</h3>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">apple: 3</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">Wheat: 4</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl mb-4 sm:mb-6">Watermelom: 1</h4>
                                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-4">Cobra</h3>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">apple: 3</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl">Wheat: 4</h4>
                                        <h4 className="w-full px-2 sm:px-6 text-base sm:text-xl mb-4 sm:mb-6">Watermelom: 1</h4>
                                    </div>
                            ...
                            <div className="flex justify-center pt-4">
                                <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white font-bold text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3 rounded-xl shadow-lg transition duration-300 transform hover:scale-105 w-full max-w-xs">Harvest</button>
                            </div>
                        </div>
                    </div>
                </div>
