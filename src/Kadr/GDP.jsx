                                ...
                                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <label className="text-white bg-gray-700 font-bold text-lg rounded-lg px-3 py-2 min-w-[120px] text-center mr-4">Panther</label>
                                            <input
                                                type="number"
                                                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-4 focus:ring-blue-400 bg-gray-50 text-lg"
                                                placeholder="300"
                                            />
                                        </div>
                                        ...
                                        {/* Tiger */}
                                        <div className="flex items-center gap-4">
                                            <label className="text-white bg-gray-700 font-bold text-lg rounded-lg px-3 py-2 min-w-[120px] text-center mr-4">Tiger</label>
                                            <input
                                                type="number"
                                                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-4 focus:ring-blue-400 bg-gray-50 text-lg"
                                                placeholder="300"
                                        ...
                                        {/* Lion */}
                                        <div className="flex items-center gap-4">
                                            <label className="text-white bg-gray-700 font-bold text-lg rounded-lg px-3 py-2 min-w-[120px] text-center mr-4">Lion</label>
                                            <input
                                                type="number"
                                                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-4 focus:ring-blue-400 bg-gray-50 text-lg"
                                                placeholder="300"
                                        ...
                                        {/* Fox */}
                                        <div className="flex items-center gap-4">
                                            <label className="text-white bg-gray-700 font-bold text-lg rounded-lg px-3 py-2 min-w-[120px] text-center mr-4">Fox</label>
                                            <input
                                                type="number"
                                                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-4 focus:ring-blue-400 bg-gray-50 text-lg"
                                                placeholder="300"
                                        ...
                                        {/* Wolf */}
                                        <div className="flex items-center gap-4">
                                            <label className="text-white bg-gray-700 font-bold text-lg rounded-lg px-3 py-2 min-w-[120px] text-center mr-4">Wolf</label>
                                            <input
                                                type="number"
                                                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-4 focus:ring-blue-400 bg-gray-50 text-lg"
                                                placeholder="300"
                                        ...
                                        {/* Cobra */}
                                        <div className="flex items-center gap-4">
                                            <label className="text-white bg-gray-700 font-bold text-lg rounded-lg px-3 py-2 min-w-[120px] text-center mr-4">Cobra</label>
                                            <input
                                                type="number"
                                                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-4 focus:ring-blue-400 bg-gray-50 text-lg"
                                                placeholder="300"
