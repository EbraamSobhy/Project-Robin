...
function Give() {
    ...
    // Navigation functions (update to match Home.jsx)
    const ViewScores = () => {
            ...
            {isMobileMenuOpen && (
                <div className="fixed top-16 left-0 w-full bg-white shadow-lg z-40 lg:hidden border-b border-blue-200">
                    <div className="flex flex-col py-4 justify-center items-center">
                        ...
                        <button className="flex items-center px-6 py-3 text-blue-700 bg-blue-50 transition"><FaHandHoldingHeart className="w-5 h-5 mr-3" /><span className="font-semibold">Give</span></button>
